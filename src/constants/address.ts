...
export const ADDRESS_OF_CHAINS = {
  [CHAINIDS.AIOZ]: {
    DEPOSIT_RATE: 1,
    WIE104: '0xcB96060104AA0529Be0B8B4c15703a962A20DF60',
    MARKET: '0x634345357C9eA4B6e52765804d647048bd15e468',
    PUBLIC_ERC721_TOKENS: '0x0000000000000000000000000000000000000000',
    COLLECTIONS: {
      DyanCat: {
  ...
  [CHAINIDS.GOERLI]: {
    DEPOSIT_RATE: 100000,
    WIE104: '0x6e339498Dce86c81F175b0bD12c3a6b7216e24cb',
    MARKET: '0xD39Cf454221404745d7C807f17c8460bE0eC8317',
    PUBLIC_ERC721_TOKENS: '0xf87d74a1B01ce51446F40A1B18dC49da4a806879',
    COLLECTIONS: {
      DyanCat: {
        owner: '0x454574C8AD9706a8fC22dDA71Ce77Cb1CDd5fEB1',
